...
//     // MeshBasicMaterial doesn't support emissive — highlight via opacity
//     skinnedMeshRef.current.material[4].opacity =
//       skinnedMeshRef.current.material[5].opacity = highlighted ? 0.85 : 1;
